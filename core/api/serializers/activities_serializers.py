...
from core.models import Activity as LOCAL_MODEL
from accounts.api.serializers.user_serialisers import UserNameSerializer, UserSlimSerializer


class HomeActivityModelSerializer(serializers.ModelSerializer):
...
class ActivityFormoLookupsSerializer(serializers.ModelSerializer):
    uuid = serializers.SerializerMethodField()
...
class ActivityTableModelSerializer(serializers.ModelSerializer):
