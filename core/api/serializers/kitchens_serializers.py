...
from core.models import Kitchen as LOCAL_MODEL
...
class HomeKitchenModelSerializer(serializers.ModelSerializer):
    kitchen_images = serializers.SerializerMethodField()

    class Meta:
        model = LOCAL_MODEL
        fields = ['kitchen_images', 'name', 'title', 'excerpt', ]
...
class KitchenModelSerializer(serializers.ModelSerializer):
...
class KitchenCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = LOCAL_MODEL
        fields = '__all__'


class KitchenDetailsSerializer(serializers.ModelSerializer):
...
class KitchenSlimSerializer(serializers.ModelSerializer):
...
class KitchenFormoLookupsSerializer(serializers.ModelSerializer):
    uuid = serializers.SerializerMethodField()
...
class KitchenTableModelSerializer(serializers.ModelSerializer):
