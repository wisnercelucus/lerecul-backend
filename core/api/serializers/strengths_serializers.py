...
from core.models import Strength as LOCAL_MODEL
from accounts.api.serializers.user_serialisers import UserNameSerializer, UserSlimSerializer


class HomeStrengthModelSerializer(serializers.ModelSerializer):
    #images = serializers.SerializerMethodField()
    #is_owned = serializers.SerializerMethodField()

    class Meta:
        model = LOCAL_MODEL
        fields = ['name', 'featured_image', 'id', '_id',]


class StrengthModelSerializer(serializers.ModelSerializer):
    is_owned = serializers.SerializerMethodField()
...
class StrengthDetailsSerializer(serializers.ModelSerializer):
...
class StrengthSlimSerializer(serializers.ModelSerializer):
...
class StrengthNameSerializer(serializers.ModelSerializer):
    class Meta:
        model = LOCAL_MODEL
        fields = ['name',]

class StrengthFormoLookupsSerializer(serializers.ModelSerializer):
    uuid = serializers.SerializerMethodField()
...
class StrengthTableModelSerializer(serializers.ModelSerializer):
