...
from core.models import Gallery as LOCAL_MODEL
...
class HomeGalleryImagesModelSerializer(serializers.ModelSerializer):
...
class HomeGalleryModelSerializer(serializers.ModelSerializer):
    gallery_images = serializers.SerializerMethodField()

    class Meta:
        model = LOCAL_MODEL
        fields = ['gallery_images', 'name', 'title', 'excerpt1', 'excerpt2', 'excerpt1_title','excerpt2_title',]
...
class GallerySlimSerializer(serializers.ModelSerializer):
...
class GalleryNameSerializer(serializers.ModelSerializer):
    class Meta:
        model = LOCAL_MODEL
        fields = ['name',]

class GalleryFormoLookupsSerializer(serializers.ModelSerializer):
    uuid = serializers.SerializerMethodField()
...
class GalleryTableModelSerializer(serializers.ModelSerializer):
