...
class CouponSlimSerializer(serializers.ModelSerializer):
...
class CouponTableModelSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = LOCAL_MODEL
        fields = ['created_at', 'updated_at', 'owner', "updated_by", 'code', 'is_owned', 'name', '_id', 'id',  ]
...
class CouponNameSerializer(serializers.ModelSerializer):
    class Meta:
        model = LOCAL_MODEL
        fields = ['name',]
