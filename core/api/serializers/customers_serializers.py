...
from core.models import Customer as LOCAL_MODEL
...
class CustomerFormoLookupsSerializer(serializers.ModelSerializer):
    uuid = serializers.SerializerMethodField()
...
class CustomerTableModelSerializer(serializers.ModelSerializer):
